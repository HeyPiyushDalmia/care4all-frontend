...
export default function Ngo_login() {
  return (
          ...
          <div className=" flex flex-col items-center">
            <div className="w-full flex-1  ">
              <a href="/Adopter_login">
                <button className="mt-5 tracking-wide font-semibold bg-orange-400 text-white-500 w-48 py-4 rounded-lg hover:bg-green-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none ml-auto mr-auto">
                  ADOPTER LOGIN
                </button>
              </a>
              ...
              <div className="mx-auto max-w-xs">
                ...
                />
                <button className="mt-5 tracking-wide font-semibold bg-orange-400 text-white-500 w-full py-4 rounded-lg hover:bg-green-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
